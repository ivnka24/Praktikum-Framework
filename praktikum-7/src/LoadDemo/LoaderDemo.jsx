import  React,  {  Component  }  from  'react'; import  LoadIndicator  from  './LoaderHOC.jsx'; import  './ContactsApp.css';

class  LoaderDemo  extends  Component  { constructor(props) {
super(props); this.state  =  {
searchText : '', searchResults:  [], contactList: []
}
this.handleUserInput  =  this.handleUserInput.bind(this);

}

handleUserInput(inputText)  { this.setState({
searchText:  inputText,
},  ()  =>  console.log(this.state))
}

componentWillMount()  { let init = {
...
.then(
    (data)  =>  {console.log(data);this.setState( prevState => ({
